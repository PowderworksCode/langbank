...
// its section index. The rendered reference pages are checked like the
// hand-written ones — the renderer runs before bun test, so a renderer that
// stops writing frontmatter fails here.
//
